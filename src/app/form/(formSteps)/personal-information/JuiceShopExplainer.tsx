...
const juiceShopExplainerItems: AccordionItemProps[] = [
  {
    ...
    content: (
      <p>
        The OWASP Juice Shop is a deliberately insecure web application that can be used in security
        trainings, awareness demos, CTFs and as a guinea pig for security tools. You can find out
        more{" "}
